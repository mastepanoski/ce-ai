# Proposal: Reposition CE-AI's Public Messaging

## Problem

The current public entry point leads with implementation terms such as “Rust CLI,” “orchestrator,” and “FSM.” That framing makes CE-AI appear to compete with coding agents or duplicate the Compound Engineering plugin. A new visitor cannot quickly tell what CE-AI is, why it exists, how it relates to Compound Engineering, or how to try it.
...
- Changing CE-AI runtime behavior, commands, supported harnesses, or release version.
- Claiming ownership of Compound Engineering or ODD.
- Submitting an upstream issue or pull request on the user’s behalf.
