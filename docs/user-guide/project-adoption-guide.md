...
| :--- | :--- | :--- |
| `full` **(Default)** | Complete 7-stage development cycle, OpenSpec requirements, DoD checklist, and security policies. | Production repositories, core services, critical products. |
| `minimal` | Core DoD guidelines, atomic write rules, and basic testing verification. | Small libraries, scripts, internal tools. |
| `orchestrator` | Multi-repo orchestration directives and cross-repository delegation protocols. | Monorepos, parent workspace folders. |
